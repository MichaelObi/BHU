                    ...
                    public void success(final Course course, Response response) {
                        new AsyncTask<Course, Void, Void>() {
                            ...
                            protected Void doInBackground(Course... params) {
                                ...
                                RealmResults<net.devdome.bhu.app.db.realm.Course> courses = realm.where(net.devdome.bhu.app.db.realm.Course.class).findAll();
                                for (int i = 0; i < courses.size(); i++) {
                                    courses.get(i).setRegistered(false);
                                }
                                realm.commitTransaction();
                                for (int i = 0; i < data.size(); i++) {
                                    net.devdome.bhu.app.db.realm.Course mCourse = new net.devdome.bhu.app.db.realm.Course();
                ...
                new AsyncTask<Course, Void, Boolean>() {
                    ...
                    protected Boolean doInBackground(Course... params) {
                        ...
                        for (Course.Data course : data) {
                            try {
                                net.devdome.bhu.app.db.realm.Course rmCourse = new net.devdome.bhu.app.db.realm.Course();
