/*
 * NOTE: This class was not written by Michael Obi (See copyright details below). Components have been modified to suit use my use case.
 *
 ...
 * the measure pass.
 */
public abstract class WrapableLinearLayoutManager extends android.support.v7.widget.LinearLayoutManager {
    ...
    public WrapableLinearLayoutManager(Context context) {
        super(context);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public WrapableLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
        this.view = null;
    }

    @SuppressWarnings("UnusedDeclaration")
    public WrapableLinearLayoutManager(RecyclerView view) {
    ...
    @SuppressWarnings("UnusedDeclaration")
    public WrapableLinearLayoutManager(RecyclerView view, int orientation, boolean reverseLayout) {
