...
import net.devdome.bhu.app.ui.activity.LoginActivity;

import static android.accounts.AccountManager.KEY_BOOLEAN_RESULT;

public class BHUAuthenticator extends AbstractAccountAuthenticator {
    private Context mContext;

    public BHUAuthenticator(Context context) {
        super(context);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        // return an error
        if (!authTokenType.equals(AccountConfig.TOKEN_TYPE)) {
